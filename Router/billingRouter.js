...
const { createBillingAddress, updateBillingAddress, deleteBillingAddress } = require('../controllers/billingAddressController');


const Authorization = require('../middleware/auth');

// Create a new billing address 
BillingRouter.post('/create-billing-address', Authorization, createBillingAddress);
